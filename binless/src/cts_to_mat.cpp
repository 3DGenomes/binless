...
template<>
void cts_to_mat(const RawData<Signal>& raw, BinnedData<Signal>& binned) {
...
template<>
void cts_to_mat(const RawData<Difference>& raw, BinnedData<Difference>& binned) {
  //compute ref matrix
  ...
  cts_to_mat(sraw_ref, sbinned_ref);
  ...
  cts_to_mat(sraw_oth, sbinned_oth);
  //report
