...
obj_lambda1_diff_base::obj_lambda1_diff_base(NumericVector value, NumericVector weight, NumericVector valuehat, double minUB) {
...
obj_lambda1_diff_base::bounds_t obj_lambda1_diff_base::optimize_bounds(double val) const {
...
obj_lambda1_diff_BIC::obj_lambda1_diff_BIC(double minUB, double tol_val,
  ...
  obj_lambda1_diff_base(value, weight, valuehat, minUB),
