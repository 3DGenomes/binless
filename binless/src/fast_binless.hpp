...
Rcpp::List binless(const DataFrame obs, unsigned nbins, double alpha, const NumericVector lam2, unsigned nouter=25, double tol_val=2e-1, unsigned bg_steps=5, unsigned free_decay=10000);

Rcpp::List binless_eval_cv(const List obs, double alpha, const NumericVector lam2, unsigned group=0, double tol_val=1e-1);

Rcpp::DataFrame binless_difference(const List obs, unsigned ref, double alpha, const NumericVector lam2, double tol_val=2e-1);
