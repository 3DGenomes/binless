...
Rcpp::List binless(const DataFrame obs, unsigned nbins, double lam2, double alpha=1., unsigned nouter=20, double tol_val=1e-1, unsigned bg_steps=5, unsigned free_decay=10000);
